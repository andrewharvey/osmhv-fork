...
abstract public class GUI
{
	...
	public void head() throws IOException
	{
		...
		out.println("");
		out.println("\tObtain the source code from https://github.com/andrewharvey/osmhv-fork (which was modified from http://gitorious.org/osmrmhv).");
		out.println("-->");
		out.println("\t<head>");
	...
	public void foot() throws IOException
	{
		...
		out.println("\t\t\t<p>This program is free software: you can redistribute it and/or modify it under the terms of the <a href=\"http://www.gnu.org/licenses/agpl.html\">GNU Affero General Public License</a> as published by the Free Software Foundation, either version 3 of the License, or (at your option) any later version. Get the source code <a href=\"https://github.com/andrewharvey/osmhv-fork/\">here</a> (which is derived from <a href=\"http://gitorious.org/osmrmhv\">here</a>).</p>");
		out.println("\t</body>");
		out.println("</html>");
	}
}
